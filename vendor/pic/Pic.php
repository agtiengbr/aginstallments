...
define('AGINSTALLMENTS_PATH_PIC_CLASS_CLASS', dirname(__FILE__) . '/');
...
class Pic {
    ...
    */
    public function layer ($src = null, $options = array()) {
        ...
        if ($img['format'] == 'png') {
            require_once AGINSTALLMENTS_PATH_PIC_CLASS_CLASS . 'imagecopymerge_alpha.function.php';
    ...
    */
    private function imagecreate($src) {
        ...
        switch ($img['format']) {
            ...
            break;
            case 'bmp':
                require_once AGINSTALLMENTS_PATH_PIC_CLASS_CLASS . 'imagecreatefrombmp.function.php';
    ...
    */
    private function image($save = null, $qualite = 90) {
        ...
        switch ($this->img['format']) {
            ...
            case 'bmp':
                require_once AGINSTALLMENTS_PATH_PIC_CLASS_CLASS . 'imagebmp.function.php';
